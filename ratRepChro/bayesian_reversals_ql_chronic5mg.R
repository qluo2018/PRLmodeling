...
# Adopted from Rudolf Cardinal for JK, 19 Dec 2017
# . ~/activate_venv.sh
...
FIT_CACHE_DIR <- paste(THIS_SCRIPT_DIR, "fitcache5mg", sep="/")
...
SOURCEDATA_FILENAME <-  "cleaned_chronic_5mg_bari.csv" #"cleaned_chronic_5mg_bari.csv"
...
presentation2 <- function(model = NULL)
{
    ...
    ggsave("output/ct_bariChron5mg7595.pdf", p2_ct, width=17.5, height=7.5, units="cm")
}
